...
//    private int editIdx;
//    private SQLiteTimeTable timeTableDatabaseHelper;
//    @Override
...
//        timeTableDatabaseHelper = new SQLiteTimeTable(this);
...
//                    timeTableDatabaseHelper.add(schedule);
...
//                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
//                    schedules.add(schedule);
//                    timeTableDatabaseHelper.update(schedule,editIdx);
...
//                Intent i = new Intent();
//                timeTableDatabaseHelper.deleteItemSelected(editIdx);
//                i.putExtra("idx",editIdx);
